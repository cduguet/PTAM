...
function Qd= ConstructQdAnalytic(delta_t,C_q_w_i_hat, Cross_a_x, Cross_omega_x,Cross_omega_x2, var_na, var_nba, var_nomega, var_nbomega, var_nL)
    ...
    {
        {(1/4)*(dt^5/5)*s2^2*C_q_w_i2 - (dt^3/3)*s1^2*Cq__ax2__Cq - s3^2*Cq__ax__Cq * (dt^5/20 + (dt^7*wx^2)/504 + (dt^9*wx^4)/5184) * Cq__ax__Cq + s4^2*Cq__ax__Cq * (-(dt^7/252) + (13*dt^9*wx^2)/25920 - (dt^11*wx^4)/158400) * Cq__ax__Cq,
        
         (1/2)*(dt^4/4)*s2^2*C_q_w_i2 - (dt^2/2)*s1^2*Cq__ax2__Cq - s3^2*Cq__ax__Cq * (dt^4/8  + (dt^5*wx)/60 + (dt^6*wx^2)/144 - (dt^7*wx^3)/ 1008 + (dt^8*wx^4)/1152) * Cq__ax__Cq - s4^2* Cq__ax__Cq * (dt^6/72 + (dt^7*wx)/1008 - (dt^8*wx^2)/1920 - (dt^9*wx^3)/ 2880 - (dt^10*wx^4)/28800) * Cq__ax__Cq,
     
         (-s3^2)* Cq__ax__Cq * (dt^3/6 + (dt^4*wx)/12 + (dt^5*wx^2)/40 - (dt^6*wx^3)/ 144 + (dt^7*wx^4)/336) + s4^2* Cq__ax__Cq * (-(dt^5/30) - (dt^6*wx)/144 + (dt^7*wx^2)/5040 + (dt^8*wx^3)/720 + (dt^9*wx^4)/6480),
       ...
       {(1/2)*(dt^4/4)*s2^2*C_q_w_i2 - (dt^2/2)*s1^2* Cq__ax2__Cq - s3^2* Cq__ax__Cq * (dt^4/8 - (dt^5*wx)/60 + (dt^6*wx^2)/144 + (dt^7*wx^3)/ 1008 + (dt^8*wx^4)/1152) * Cq__ax__Cq - s4^2*   Cq__ax__Cq * (dt^6/72 - (dt^7*wx)/1008 - (dt^8*wx^2)/1920 + (dt^9*wx^3)/        2880 - (dt^10*wx^4)/28800) * Cq__ax__Cq,
        ...
        (dt^3/3)*s2^2*C_q_w_i2 - s1^2*Cq__ax2__Cq*dt - s3^2*Cq__ax__Cq* (dt^3/3 + (dt^5*wx^2)/60 + (dt^7*wx^4)/252) * Cq__ax__Cq - s4^2* Cq__ax__Cq * (dt^5/20 + (dt^7*wx^2)/504 + (dt^9*wx^4)/5184) * Cq__ax__Cq,
        
        (-s3^2)* Cq__ax__Cq * (dt^2/2 + (dt^3*wx)/6 + (dt^4*wx^2)/24 - (dt^5*wx^3)/60 + (dt^6*wx^4)/72) - s4^2* Cq__ax__Cq * (dt^4/8 + (dt^5*wx)/60 + (dt^6*wx^2)/144 - (dt^7*wx^3)/        1008 + (dt^8*wx^4)/1152),
        ...
        {s3^2*(dt^3/6 - (dt^4*wx)/12 + (dt^5*wx^2)/40 + (dt^6*wx^3)/144 + (dt^7*wx^4)/336) * Cq__ax__Cq - s4^2*(-(dt^5/30) + (dt^6*wx)/144 + (dt^7*wx^2)/5040 - (dt^8*wx^3)/720 + (dt^9*wx^4)/6480) * Cq__ax__Cq,
        
        s3^2*(dt^2/2 - (dt^3*wx)/6 + (dt^4*wx^2)/24 + (dt^5*wx^3)/60 + (dt^6*wx^4)/72) * Cq__ax__Cq +s4^2*(dt^4/8 - (dt^5*wx)/60 + (dt^6*wx^2)/144 + (dt^7*wx^3)/1008 + (dt^8*wx^4)/1152) * Cq__ax__Cq,
        
        s3^2*(dt + (dt^5*wx^4)/20) - s4^2*(-(dt^3/3) - (dt^5*wx^2)/60 - (dt^7*wx^4)/252), 
